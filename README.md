...
* Additional setup required: After cloning or pulling this branch, you will need to run `cargo run --package=ootr-build`. To get `cargo`, [install Rust](https://www.rust-lang.org/tools/install).
...
* New settings presets:
  ...
  * “5th Mixed Pools Tournament” is used for [an upcoming tournament](https://midos.house/event/mp/5) with nearly full mixed pools entrance randomizer.
  ...
  * “SlugCentral Open Triforce Hunt” is one of the formats featured in [an upcoming tournament](https://midos.house/event/sco/2026).
* Other changes:
