...
item_table: dict[str, tuple[str, Optional[bool], Optional[int], Optional[dict[str, Any]]]] = {
    ...
    'Minuet of Forest':                                         ('Song',        True,  GetItemId.GI_MINUET_OF_FOREST, {'text_id': 0x73, 'song_id': 0x02, 'item_id': 0x5A}),
    'Bolero of Fire':                                           ('Song',        True,  GetItemId.GI_BOLERO_OF_FIRE, {'text_id': 0x74, 'song_id': 0x03, 'item_id': 0x5B}),
    'Serenade of Water':                                        ('Song',        True,  GetItemId.GI_SERENADE_OF_WATER, {'text_id': 0x75, 'song_id': 0x04, 'item_id': 0x5C}),
    'Requiem of Spirit':                                        ('Song',        True,  GetItemId.GI_REQUIEM_OF_SPIRIT, {'text_id': 0x76, 'song_id': 0x05, 'item_id': 0x5D}),
    'Nocturne of Shadow':                                       ('Song',        True,  GetItemId.GI_NOCTURNE_OF_SHADOW, {'text_id': 0x77, 'song_id': 0x06, 'item_id': 0x5E}),
    'Prelude of Light':                                         ('Song',        True,  GetItemId.GI_PRELUDE_OF_LIGHT, {'text_id': 0x78, 'song_id': 0x07, 'item_id': 0x5F}),
    'Zeldas Lullaby':                                           ('Song',        True,  GetItemId.GI_ZELDAS_LULLABY, {'text_id': 0xD4, 'song_id': 0x0A, 'item_id': 0x60}),
    'Eponas Song':                                              ('Song',        True,  GetItemId.GI_EPONAS_SONG, {'text_id': 0xD2, 'song_id': 0x09, 'item_id': 0x61}),
    'Sarias Song':                                              ('Song',        True,  GetItemId.GI_SARIAS_SONG, {'text_id': 0xD1, 'song_id': 0x08, 'item_id': 0x62}),
    'Suns Song':                                                ('Song',        True,  GetItemId.GI_SUNS_SONG, {'text_id': 0xD3, 'song_id': 0x0B, 'item_id': 0x63}),
    'Song of Time':                                             ('Song',        True,  GetItemId.GI_SONG_OF_TIME, {'text_id': 0xD5, 'song_id': 0x0C, 'item_id': 0x64}),
    'Song of Storms':                                           ('Song',        True,  GetItemId.GI_SONG_OF_STORMS, {'text_id': 0xD6, 'song_id': 0x0D, 'item_id': 0x65}),
