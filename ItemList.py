...
item_table: dict[str, tuple[str, Optional[bool], Optional[int], dict[str, Any]]] = {
    ...
    'Bombchus (10)':                                   ('Item',     True,  0x0003, {}),
    'Boomerang':                                       ('Item',     True,  0x0006, {}),
    'Deku Stick (1)':                                  ('Item',     None,  0x0007, {'junk': 5}),
    'Lens of Truth':                                   ('Item',     True,  0x000A, {}),
    'Megaton Hammer':                                  ('Item',     True,  0x000D, {}),
    'Cojiro':                                          ('Item',     True,  0x000E, {'trade': True}),
    'Bottle':                                          ('Item',     True,  0x000F, {'bottle': float('Inf')}),
    'Blue Potion':                                     ('Item',     True,  0x0012, {}), # distinct from shop item
    'Bottle with Milk':                                ('Item',     True,  0x0014, {'bottle': float('Inf')}),
    'Rutos Letter':                                    ('Item',     True,  0x0015, {}),
    ...
    'Kokiri Sword':                                    ('Item',     True,  0x0027, {}),
    'Giants Knife':                                    ('Item',     None,  0x0028, {}),
    'Deku Shield':                                     ('Item',     None,  0x0029, {}),
    'Hylian Shield':                                   ('Item',     None,  0x002A, {}),
    'Mirror Shield':                                   ('Item',     True,  0x002B, {}),
    'Goron Tunic':                                     ('Item',     True,  0x002C, {}),
    'Zora Tunic':                                      ('Item',     True,  0x002D, {}),
    'Iron Boots':                                      ('Item',     True,  0x002E, {}),
    'Hover Boots':                                     ('Item',     True,  0x002F, {}),
    'Stone of Agony':                                  ('Item',     True,  0x0039, {}),
    'Gerudo Membership Card':                          ('Item',     True,  0x003A, {}),
    ...
    'Boss Key':                                        ('BossKey',  True,  0x003F, {}),
    'Compass':                                         ('Compass',  None,  0x0040, {}),
    'Map':                                             ('Map',      None,  0x0041, {}),
    ...
    'Biggoron Sword':                                  ('Item',     None,  0x0057, {}),
    'Fire Arrows':                                     ('Item',     True,  0x0058, {}),
    'Ice Arrows':                                      ('Item',     True,  0x0059, {}),
    'Blue Fire Arrows':                                ('Item',     True,  0x0059, {}),
    'Light Arrows':                                    ('Item',     True,  0x005A, {}),
    'Gold Skulltula Token':                            ('Token',    True,  0x005B, {'progressive': float('Inf')}),
    'Dins Fire':                                       ('Item',     True,  0x005C, {}),
    'Nayrus Love':                                     ('Item',     True,  0x005E, {}),
    'Farores Wind':                                    ('Item',     True,  0x005D, {}),
    ...
    'Bombchus (5)':                                    ('Item',     True,  0x006A, {}),
    'Bombchus (20)':                                   ('Item',     True,  0x006B, {}),
    'Small Key (Treasure Chest Game)':              ('TCGSmallKey', True,  0x0071, {'progressive': float('Inf')}),
    'Rupee (Treasure Chest Game) (1)':                 ('Item',     None,  0x0072, {}),
    'Rupees (Treasure Chest Game) (5)':                ('Item',     None,  0x0073, {}),
    'Rupees (Treasure Chest Game) (20)':               ('Item',     None,  0x0074, {}),
    'Rupees (Treasure Chest Game) (50)':               ('Item',     None,  0x0075, {}),
    ...
    'Bomb Bag':                                        ('Item',     True,  0x0082, {}),
    'Bow':                                             ('Item',     True,  0x0083, {}),
    'Slingshot':                                       ('Item',     True,  0x0084, {}),
    'Progressive Wallet':                              ('Item',     True,  0x0085, {'progressive': 3}),
    'Progressive Scale':                               ('Item',     True,  0x0086, {'progressive': 2}),
    'Deku Nut Capacity':                               ('Item',     None,  0x0087, {}),
    'Deku Stick Capacity':                             ('Item',     None,  0x0088, {}),
    'Bombchus':                                        ('Item',     True,  0x0089, {}),
    'Magic Meter':                                     ('Item',     True,  0x008A, {}),
    'Ocarina':                                         ('Item',     True,  0x008B, {}),
    ...
    'Boss Key (Forest Temple)':                        ('BossKey',  True,  0x0095, {}),
    'Boss Key (Fire Temple)':                          ('BossKey',  True,  0x0096, {}),
    'Boss Key (Water Temple)':                         ('BossKey',  True,  0x0097, {}),
    'Boss Key (Spirit Temple)':                        ('BossKey',  True,  0x0098, {}),
    'Boss Key (Shadow Temple)':                        ('BossKey',  True,  0x0099, {}),
    'Boss Key (Ganons Castle)':                   ('GanonBossKey',  True,  0x009A, {}),
    'Compass (Deku Tree)':                             ('Compass', False,  0x009B, {}),
    'Compass (Dodongos Cavern)':                       ('Compass', False,  0x009C, {}),
    'Compass (Jabu Jabus Belly)':                      ('Compass', False,  0x009D, {}),
    'Compass (Forest Temple)':                         ('Compass', False,  0x009E, {}),
    'Compass (Fire Temple)':                           ('Compass', False,  0x009F, {}),
    'Compass (Water Temple)':                          ('Compass', False,  0x00A0, {}),
    'Compass (Spirit Temple)':                         ('Compass', False,  0x00A1, {}),
    'Compass (Shadow Temple)':                         ('Compass', False,  0x00A2, {}),
    'Compass (Bottom of the Well)':                    ('Compass', False,  0x00A3, {}),
    'Compass (Ice Cavern)':                            ('Compass', False,  0x00A4, {}),
    'Map (Deku Tree)':                                 ('Map',     False,  0x00A5, {}),
    'Map (Dodongos Cavern)':                           ('Map',     False,  0x00A6, {}),
    'Map (Jabu Jabus Belly)':                          ('Map',     False,  0x00A7, {}),
    'Map (Forest Temple)':                             ('Map',     False,  0x00A8, {}),
    'Map (Fire Temple)':                               ('Map',     False,  0x00A9, {}),
    'Map (Water Temple)':                              ('Map',     False,  0x00AA, {}),
    'Map (Spirit Temple)':                             ('Map',     False,  0x00AB, {}),
    'Map (Shadow Temple)':                             ('Map',     False,  0x00AC, {}),
    'Map (Bottom of the Well)':                        ('Map',     False,  0x00AD, {}),
    'Map (Ice Cavern)':                                ('Map',     False,  0x00AE, {}),
    ...
    'Double Defense':                                  ('Item',     None,  0x00B8, {}),
