...
item_table: dict[str, tuple[str, Optional[bool], Optional[int], Optional[dict[str, Any]]]] = {
    ...
    'Triforce of Power':                               ('Item',     True,  GetItemId.GI_TRIFORCE_OF_POWER, {'alias': ('Triforce Piece', 1)}),
    'Triforce of Wisdom':                              ('Item',     True,  GetItemId.GI_TRIFORCE_OF_WISDOM, {'alias': ('Triforce Piece', 1)}),
    'Triforce of Courage':                             ('Item',     True,  GetItemId.GI_TRIFORCE_OF_COURAGE, {'alias': ('Triforce Piece', 1)}),
    ...
    'Bomb Bag Hint':                    ('Hint',     True, GetItemId.GI_BOMB_BAG_HINT, None),
    'Bow Hint':                         ('Hint',     True, GetItemId.GI_BOW_HINT, None),
    'Hookshot Hint':                    ('Hint',     True, GetItemId.GI_HOOKSHOT_HINT, None),
    'Magic Hint':                       ('Hint',     True, GetItemId.GI_MAGIC_HINT, None),
    'Silver Gauntlets Hint':            ('Hint',     True, GetItemId.GI_SILVER_GAUNTLETS_HINT, None),
    'Goron Bracelet Hint':              ('Hint',     True, GetItemId.GI_GORON_BRACELET_HINT, None),
    'Silver Scale Hint':                ('Hint',     True, GetItemId.GI_SILVER_SCALE_HINT, None),
    'Wallet Hint':                      ('Hint',     True, GetItemId.GI_WALLET_HINT, None),
