...
hintTable = {
    ...
    'Fire Temple Pierre and Hammer':                               ("a #scarecrow and a flare dancer# atop the Fire Temple guard...^", None, 'dual'),
    ...
    # 'Spirit Temple Adult Lower':                                   ("#past the entrance's silver block in the Spirit Temple# a melody and boulders guard...^", None, 'dual'),
...
multiTable = {
    ...
    # 'HF Southern Bombable Grottos':                             ['HF Deku Scrub Grotto', 'HF Southeast Grotto Chest'],
    'LH Child and Adult Fishing':                               ['LH Child Fishing', 'LH Adult Fishing'],
    'ZD Child Checks':                                          ['ZD Diving Minigame', 'ZD Chest'],
    # 'ZF Adult Checks':                                          ['ZF Iceberg Freestanding PoH', 'ZF Bottom Freestanding PoH'],
