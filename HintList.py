...
hintTable = {
    ...
    'Silver Rupee (Dodongos Cavern Staircase)':                 (["an entry fee for an immense cavern"], "a Silver Rupee for Dodongo's Cavern", 'item'),
    'Silver Rupee (Ice Cavern Spinning Scythe)':                (["an entry fee for a frozen maze"], "a Silver Rupee for the Ice Cavern", 'item'),
    'Silver Rupee (Ice Cavern Push Block)':                     (["an entry fee for a frozen maze"], "a Silver Rupee for the Ice Cavern", 'item'),
    'Silver Rupee (Bottom of the Well Basement)':               (["an entry fee for a shadow's prison"], "a Silver Rupee for the Bottom of the Well", 'item'),
    'Silver Rupee (Shadow Temple Scythe Shortcut)':             (["an entry fee for the house of the dead"], "a Silver Rupee for the Shadow Temple", 'item'),
    'Silver Rupee (Shadow Temple Invisible Blades)':            (["an entry fee for the house of the dead"], "a Silver Rupee for the Shadow Temple", 'item'),
    'Silver Rupee (Shadow Temple Huge Pit)':                    (["an entry fee for the house of the dead"], "a Silver Rupee for the Shadow Temple", 'item'),
    'Silver Rupee (Shadow Temple Invisible Spikes)':            (["an entry fee for the house of the dead"], "a Silver Rupee for the Shadow Temple", 'item'),
    'Silver Rupee (Gerudo Training Ground Slopes)':             (["an entry fee for the test of thieves"], "a Silver Rupee for the Gerudo Training Ground", 'item'),
    'Silver Rupee (Gerudo Training Ground Lava)':               (["an entry fee for the test of thieves"], "a Silver Rupee for the Gerudo Training Ground", 'item'),
    'Silver Rupee (Gerudo Training Ground Water)':              (["an entry fee for the test of thieves"], "a Silver Rupee for the Gerudo Training Ground", 'item'),
    'Silver Rupee (Spirit Temple Child Early Torches)':         (["an entry fee for a goddess of the sand"], "a Silver Rupee for the Spirit Temple", 'item'),
    'Silver Rupee (Spirit Temple Adult Boulders)':              (["an entry fee for a goddess of the sand"], "a Silver Rupee for the Spirit Temple", 'item'),
    'Silver Rupee (Spirit Temple Lobby and Lower Adult)':       (["an entry fee for a goddess of the sand"], "a Silver Rupee for the Spirit Temple", 'item'),
    'Silver Rupee (Spirit Temple Sun Block)':                   (["an entry fee for a goddess of the sand"], "a Silver Rupee for the Spirit Temple", 'item'),
    'Silver Rupee (Spirit Temple Adult Climb)':                 (["an entry fee for a goddess of the sand"], "a Silver Rupee for the Spirit Temple", 'item'),
    'Silver Rupee (Ganons Castle Spirit Trial)':                (["an entry fee for a conquered citadel"], "a Silver Rupee for Ganon's Castle", 'item'),
    'Silver Rupee (Ganons Castle Light Trial)':                 (["an entry fee for a conquered citadel"], "a Silver Rupee for Ganon's Castle", 'item'),
    'Silver Rupee (Ganons Castle Fire Trial)':                  (["an entry fee for a conquered citadel"], "a Silver Rupee for Ganon's Castle", 'item'),
    'Silver Rupee (Ganons Castle Shadow Trial)':                (["an entry fee for a conquered citadel"], "a Silver Rupee for Ganon's Castle", 'item'),
    'Silver Rupee (Ganons Castle Water Trial)':                 (["an entry fee for a conquered citadel"], "a Silver Rupee for Ganon's Castle", 'item'),
    'Silver Rupee (Ganons Castle Forest Trial)':                (["an entry fee for a conquered citadel"], "a Silver Rupee for Ganon's Castle", 'item'),
