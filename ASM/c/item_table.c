...
item_row_t item_table[] = {
    ...
    [0x1010] = ITEM_ROW(0x4D,       BROWN_CHEST, 0x83,  3, 0x90E0, 0x00BF, 0x18, no_upgrade, no_effect, -1, -1, NULL), // Bomb Bag Hint
    [0x1011] = ITEM_ROW(0x4D,       BROWN_CHEST, 0x83,  3, 0x90E0, 0x00E9, 0x35, no_upgrade, no_effect, -1, -1, NULL), // Bow Hint
    [0x1012] = ITEM_ROW(0x4D,       BROWN_CHEST, 0x83,  3, 0x90E0, 0x00DD, 0x2D, no_upgrade, no_effect, -1, -1, NULL), // Hookshot Hint
    [0x1013] = ITEM_ROW(0x4D,       BROWN_CHEST, 0x83,  3, 0x90E0, 0x00CD, 0x1E, no_upgrade, no_effect, -1, -1, NULL), // Magic Hint
    [0x1014] = ITEM_ROW(0x4D,       BROWN_CHEST, 0x83,  3, 0x90E0, 0x012D, 0x49, no_upgrade, no_effect, -1, -1, NULL), // Silver Gauntlets Hint
    [0x1015] = ITEM_ROW(0x4D,       BROWN_CHEST, 0x83,  3, 0x90E0, 0x0147, 0x58, no_upgrade, no_effect, -1, -1, NULL), // Goron Bracelet Hint
    [0x1016] = ITEM_ROW(0x4D,       BROWN_CHEST, 0x83,  3, 0x90E0, 0x00DB, 0x2A, no_upgrade, no_effect, -1, -1, NULL), // Silver Scale Hint
    [0x1017] = ITEM_ROW(0x4D,       BROWN_CHEST, 0x83,  3, 0x90E0, 0x00D1, 0x22, no_upgrade, no_effect, -1, -1, NULL), // Wallet Hint
};
