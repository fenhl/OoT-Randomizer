...
item_row_t item_table[] = {
    ...
    [0x0003] = ITEM_ROW(0x4D, BOMBCHU_CHEST_SMALL, 0x09, -1, 0x90AB, 0x00D9, 0x28, bombchus_to_bag, no_effect, -1, -1, NULL), // Bombchu (10)
    ...
    [0x006A] = ITEM_ROW(0x4D, BOMBCHU_CHEST_SMALL, 0x96, -1, 0x90AB, 0x00D9, 0x28, bombchus_to_bag, no_effect, -1, -1, NULL), // Bombchu (5)
    [0x006B] = ITEM_ROW(0x4D, BOMBCHU_CHEST_SMALL, 0x97, -1, 0x90AB, 0x00D9, 0x28, bombchus_to_bag, no_effect, -1, -1, NULL), // Bombchu (20)
