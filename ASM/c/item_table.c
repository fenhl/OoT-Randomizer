...
item_row_t item_table[GI_RANDO_MAX] = {
    ...
    [GI_BOMBCHUS_10]                                            = ITEM_ROW(0x4D, BOMBCHU_CHEST_SMALL, 0x09, -1, 0x90AB, 0x00D9, 0x28, bombchus_to_bag, no_effect, -1, -1, NULL), // Bombchu (10)
    ...
    [GI_BOMBCHUS_5]                                             = ITEM_ROW(0x4D, BOMBCHU_CHEST_SMALL, 0x96, -1, 0x90AB, 0x00D9, 0x28, bombchus_to_bag, no_effect, -1, -1, NULL), // Bombchu (5)
    [GI_BOMBCHUS_20]                                            = ITEM_ROW(0x4D, BOMBCHU_CHEST_SMALL, 0x97, -1, 0x90AB, 0x00D9, 0x28, bombchus_to_bag, no_effect, -1, -1, NULL), // Bombchu (20)
    ...
    [GI_TRIFORCE_OF_POWER]                                      = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x90E0, 0x0193, 0x76, no_upgrade, give_triforce_piece, -1, -1, NULL), // Triforce of Power
    [GI_TRIFORCE_OF_WISDOM]                                     = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x90E1, 0x0193, 0x76, no_upgrade, give_triforce_piece, -1, -1, NULL), // Triforce of Wisdom
    [GI_TRIFORCE_OF_COURAGE]                                    = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x90E2, 0x0193, 0x76, no_upgrade, give_triforce_piece, -1, -1, NULL), // Triforce of Courage

    [GI_BOMB_BAG_HINT]                                          = ITEM_ROW(0x4D,       BROWN_CHEST, 0x83,  3, 0x90F0, 0x00BF, 0x18, no_upgrade, no_effect, -1, -1, NULL), // Bomb Bag Hint
    [GI_BOW_HINT]                                               = ITEM_ROW(0x4D,       BROWN_CHEST, 0x83,  3, 0x90F1, 0x00E9, 0x35, no_upgrade, no_effect, -1, -1, NULL), // Bow Hint
    [GI_HOOKSHOT_HINT]                                          = ITEM_ROW(0x4D,       BROWN_CHEST, 0x83,  3, 0x90F2, 0x00DD, 0x2D, no_upgrade, no_effect, -1, -1, NULL), // Hookshot Hint
    [GI_MAGIC_HINT]                                             = ITEM_ROW(0x4D,       BROWN_CHEST, 0x83,  3, 0x90F3, 0x00CD, 0x1E, no_upgrade, no_effect, -1, -1, NULL), // Magic Hint
    [GI_SILVER_GAUNTLETS_HINT]                                  = ITEM_ROW(0x4D,       BROWN_CHEST, 0x83,  3, 0x90F4, 0x012D, 0x49, no_upgrade, no_effect, -1, -1, NULL), // Silver Gauntlets Hint
    [GI_GORON_BRACELET_HINT]                                    = ITEM_ROW(0x4D,       BROWN_CHEST, 0x83,  3, 0x90F5, 0x0147, 0x58, no_upgrade, no_effect, -1, -1, NULL), // Goron Bracelet Hint
    [GI_SILVER_SCALE_HINT]                                      = ITEM_ROW(0x4D,       BROWN_CHEST, 0x83,  3, 0x90F6, 0x00DB, 0x2A, no_upgrade, no_effect, -1, -1, NULL), // Silver Scale Hint
    [GI_WALLET_HINT]                                            = ITEM_ROW(0x4D,       BROWN_CHEST, 0x83,  3, 0x90F7, 0x00D1, 0x22, no_upgrade, no_effect, -1, -1, NULL), // Wallet Hint
};
