...
hintTable = {
    ...
    'KF Links House':                                           ("リンクの家には", None, 'region'),
    'Temple of Time':                                           ("C時の神殿Cには", None, 'region'),
    'KF Midos House':                                           ("ミドの家には", None, 'region'),
    'KF Sarias House':                                          ("サリアの家には", None, 'region'),
    'KF House of Twins':                                        ("C双子の家Cには", None, 'region'),
    'KF Know It All House':                                     ("物知り兄弟の家には", None, 'region'),
    ...
    'Market Man in Green House':                                ("民家には", None, 'region'),
    ...
    'Kak Impas House':                                          ("インパの家には", None, 'region'),
    'Kak Impas House Back':                                     ("インパの牛小屋には", None, 'region'),
    'Kak Odd Medicine Building':                                ("オババのクスリ屋には", None, 'region'),
    'Graveyard Dampes House':                                   ("ダンペイの小屋には", None, 'region'),
    'GC Shop':                                                  ("Cゴロンの店Cには", None, 'region'),
    'ZD Shop':                                                  ("Cゾーラの店Cには", None, 'region'),
    'LLR Talons House':                                         ("タロンの家には", None, 'region'),
    ...
    'Graveyard Dampes Grave':                                   ("ダンペイの墓には", None, 'region'),
    ...
    'Colossus Grotto':                                          ("２体のアキンド穴には", None, 'region'),
    'ZR Storms Grotto':                                         ("２体のアキンド穴には", None, 'region'),
    'SFM Storms Grotto':                                        ("２体のアキンド穴には", None, 'region'),
    'GV Storms Grotto':                                         ("２体のアキンド穴には", None, 'region'),
    'LH Grotto':                                                ("３体のアキンド穴には", None, 'region'),
    'DMC Hammer Grotto':                                        ("３体のアキンド穴には", None, 'region'),
    'GC Grotto':                                                ("３体のアキンド穴には", None, 'region'),
    'LLR Grotto':                                               ("３体のアキンド穴には", None, 'region'),
