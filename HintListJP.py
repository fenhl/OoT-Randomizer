...
hintTable = {
    ...
    'Hyrule Castle':                                            ("Cハイラル城Cには", None, 'region'),
    'Hyrule Field':                                             ("Cハイラル平原Cには", None, 'region'),
    'Kokiri Forest':                                            ("Cコキリの森Cには", None, 'region'),
    'Lake Hylia':                                               ("Cハイリア湖畔Cには", None, 'region'),
    'Lon Lon Ranch':                                            ("Cロンロン牧場Cには", None, 'region'),
    ...
    'Thieves Hideout':                                          ("CアジトCの中には", None, 'region'),
    "Zora's Domain":                                             ("Cゾーラの里Cには", None, 'region'),
    "Zora's Fountain":                                           ("Cゾーラの泉Cには", None, 'region'),
    "Zora's River":                                              ("Cゾーラ川Cには", None, 'region'),
    "Kakariko Village":                                          ("Cカカリコ村Cには", None, 'region'),
    "the Graveyard":                                             ("C墓場Cには", None, 'region'),
    ...
    'Market Potion Shop':                                       ("C町のクスリ屋Cには", None, 'region'),
    ...
    'Market Bazaar':                                            ("C町のなンでも屋Cには", None, 'region'),
    'Market Shooting Gallery':                                  ("C町の的当屋Cには", None, 'region'),
    'Kak Bazaar':                                               ("C村のなンでも屋Cには", None, 'region'),
    'Kak Potion Shop Front':                                    ("C村のクスリ屋Cには", None, 'region'),
    'Kak Potion Shop Back':                                     ("C村のクスリ屋Cには", None, 'region'),
    'Kak Shooting Gallery':                                     ("C村の的当屋Cには", None, 'region'),
    ...
    'Bottom of the Well':                                       ("C影の捕う場所Cには", "C井戸の底Cには", 'dungeonName'),
