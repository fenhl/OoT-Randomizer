...
class HintEX(object):
    ...
    def __init__(self, name, text, type, choice=None):
        ...
        if isinstance(name, str):
            ...
            if choice == None:
                self.text = random.choice(name)
            else:
                self.text = name[choice]
...
hintTable = {
    ...
    'Progressive Strength Upgrade':                             (["力のグローブ", "力持ち"], "腕輪", 'item'),
    ...
    'Rupee (Treasure Chest Game)':                              ("ゴミ", '１ルピー', 'item'),
    ...
    'Map (Bottom of the Well)':                                 (["井戸の地図", "井戸の見取り図"], "井戸の底の地図", 'item'),
    ...
    'Compass (Bottom of the Well)':                             (["井戸の探知機", "井戸の羅針盤"], "井戸の底のコンパス", 'item'),
    ...
    'Song from Ocarina of Time':                                   ("Cオカリナの歌Cは", None, ['song', 'sometimes']),
    ...
    'Sheik at Colossus':                                           ("C荒れ地の先Cには", None, ['song', 'sometimes']),
    ...
    'GC Darunias Joy':                                             ("C踊るゴロンCが渡すのは", "CダルニアCが渡すのは", ['overworld', 'sometimes']),
    'LW Skull Kid':                                                ("CスタルキッドCの持つものは", None, ['overworld', 'sometimes']),
    'LH Sun':                                                      ("C太陽Cを見つめると", "C太陽Cを撃つと", ['overworld', 'sometimes']),
    'Market Treasure Chest Game Reward':                           (["C賭けに勝つCと", "C１／３２の確立Cで受け取るのは"], "C宝箱屋Cは", ['overworld', 'sometimes']),
    ...
    'ZF Bottom Freestanding PoH':                                  ("C氷の下Cには", None, ['overworld', 'sometimes']),
    'GC Pot Freestanding PoH':                                     ("CゴロンのツボCにあるのは", None, ['overworld', 'sometimes']),
    'ZD King Zora Thawed':                                         ("C解けた王Cが渡すのは", "CキングゾーラCが渡すのは", ['overworld', 'sometimes']),
    ...
    'SFM GS':                                                      ("C森の聖域の夜クモCは", None, 'exclude'),
    ...
    'Gerudo Fortress -> GF Storms Grotto':                      ("Cゲルドの砦の嵐穴Cは", None, 'entrance'),
    'Zoras Domain -> ZD Storms Grotto':                         ("Cゾーラの里の嵐穴Cは", None, 'entrance'),
    'Hyrule Castle Grounds -> HC Storms Grotto':                ("C城の近くの嵐穴Cは", None, 'entrance'),
    'GV Fortress Side -> GV Storms Grotto':                     ("C谷の嵐穴Cは", None, 'entrance'),
    ...
    "Dodongo's Cavern":                                          ("C巨大な洞窟Cには", "Cドドンゴの洞窟Cには", 'region'),
    "Jabu Jabu's Belly":                                         ("C神の腹の中Cには", "Cジャブジャブ様のお腹Cには", 'region'),
    "Ganon's Castle":                                            ("C乗っ取られた城Cには", "Cガノン城Cには", 'region'),
    'Desert Colossus':                                          ("C巨大邪神像Cには", None, 'region'),
    'Death Mountain Crater':                                    ("C火口Cには", None, 'region'),
    'Death Mountain Trail':                                     ("C登山道Cには", None, 'region'),
    'Goron City':                                               ("CゴロンシティCには", None, 'region'),
    "Gerudo's Fortress":                                         ("Cゲルドの砦Cには", None, 'region'),
    'Gerudo Valley':                                            ("Cゲルドの谷Cには", None, 'region'),
    'Hyrule Castle':                                            ("C王家の住処Cには", "Cハイラル城Cには", 'region'),
    'Hyrule Field':                                             ("C母なる大地Cには", "Cハイラル平原Cには", 'region'),
    'Kokiri Forest':                                            ("Cコキリの森Cには", None, 'region'),
    'Lake Hylia':                                               ("Cハイリア湖畔Cには", None, 'region'),
    'Lon Lon Ranch':                                            ("C高原の牧場Cには", "Cロンロン牧場Cには", 'region'),
    'the Lost Woods':                                               ("C迷いの森Cには", None, 'region'),
    "outside Ganon's Castle":                                    ("Cガノン城Cの外には", None, 'region'),
    'Sacred Forest Meadow':                                     ("C森の聖域Cには", None, 'region'),
    'Thieves Hideout':                                          ("CアジトCの中には", "C盗賊団のアジトCには", 'region'),
    "Zora's Domain":                                             ("Cゾーラの里Cには", None, 'region'),
    "Zora's Fountain":                                           ("Cゾーラの泉Cには", None, 'region'),
    "Zora's River":                                              ("Cゾーラ川Cには", None, 'region'),
    "Kakariko Village":                                          ("Cシーカー族の村Cには", "Cカカリコ村Cには", 'region'),
    "the Graveyard":                                             ("C命眠る所Cには", "C墓場Cには", 'region'),
    "the Market":                                                ("C城下町Cには", None, 'region'),    
    "Haunted Wasteland":                                        ("C幻影の砂漠Cには", None, 'region'),
    'KF Links House':                                           ("Cリンクの家Cには", None, 'region'),
    'Temple of Time':                                           ("C時の神殿Cには", None, 'region'),
    'KF Midos House':                                           ("Cミドの家Cには", None, 'region'),
    'KF Sarias House':                                          ("Cサリアの家Cには", None, 'region'),
    'KF House of Twins':                                        ("C双子の家Cには", None, 'region'),
    'KF Know It All House':                                     ("C物知り兄弟の家Cには", None, 'region'),
    'KF Kokiri Shop':                                           ("Cコキリの店Cには", None, 'region'),
    'LH Lab':                                                   ("Cみずうみ研究所Cには", None, 'region'),
    'LH Fishing Hole':                                          ("CつりぼりCには", None, 'region'),
    'GV Carpenter Tent':                                        ("C大工のテントCには", None, 'region'),
    'Market Guard House':                                       ("C兵士詰所Cには", None, 'region'),
    'Market Mask Shop':                                         ("Cお面屋Cには", None, 'region'),
    'Market Bombchu Bowling':                                   ("CボウリングCには", None, 'region'),
    'Market Potion Shop':                                       ("Cクスリ屋Cには", "C町のクスリ屋Cには", 'region'),
    'Market Treasure Chest Game':                               ("Cクジ屋Cには", None, 'region'),
    'Market Bombchu Shop':                                      ("Cボムチュウ屋Cには", None, 'region'),
    'Market Man in Green House':                                ("C民家Cには", None, 'region'),
    'Kak Windmill':                                             ("C風車Cには", None, 'region'),
    'Kak Carpenter Boss House':                                 ("C大工の家Cには", None, 'region'),
    'Kak House of Skulltula':                                   ("CスタルチュラハウスCには", None, 'region'),
    'Kak Impas House':                                          ("Cインパの家Cには", None, 'region'),
    'Kak Impas House Back':                                     ("Cインパの牛小屋Cには", None, 'region'),
    'Kak Odd Medicine Building':                                ("Cオババのクスリ屋Cには", None, 'region'),
    'Graveyard Dampes House':                                   ("Cダンペイの小屋Cには", None, 'region'),
    'GC Shop':                                                  ("Cゴロンの店Cには", None, 'region'),
    'ZD Shop':                                                  ("Cゾーラの店Cには", None, 'region'),
    'LLR Talons House':                                         ("Cタロンの家Cには", None, 'region'),
    'LLR Stables':                                              ("C馬小屋Cには", None, 'region'),
    'LLR Tower':                                                ("C納屋Cには", None, 'region'),
    'Market Bazaar':                                            ("Cなンでも屋Cには", "C町のなンでも屋Cには", 'region'),
    'Market Shooting Gallery':                                  ("C的当屋Cには", "C町の的当屋Cには", 'region'),
    'Kak Bazaar':                                               ("Cなンでも屋Cには", "C村のなンでも屋Cには", 'region'),
    'Kak Potion Shop Front':                                    ("Cクスリ屋Cには", "C村のクスリ屋Cには", 'region'),
    'Kak Potion Shop Back':                                     ("Cクスリ屋Cには", "C村のクスリ屋Cには", 'region'),
    'Kak Shooting Gallery':                                     ("C的当屋Cには", "C村の的当屋Cには", 'region'),
    'Colossus Great Fairy Fountain':                            ("C大妖精の泉Cには", None, 'region'),
    'HC Great Fairy Fountain':                                  ("C大妖精の泉Cには", None, 'region'),
    'OGC Great Fairy Fountain':                                 ("C大妖精の泉Cには", None, 'region'),
    'DMC Great Fairy Fountain':                                 ("C大妖精の泉Cには", None, 'region'),
    'DMT Great Fairy Fountain':                                 ("C大妖精の泉Cには", None, 'region'),
    'ZF Great Fairy Fountain':                                  ("C大妖精の泉Cには", None, 'region'),
    'Graveyard Shield Grave':                                   ("C大妖精の泉Cには", None, 'region'),
    'Graveyard Heart Piece Grave':                              ("C太陽の歌Cで現れるチェストには", None, 'region'),
    'Graveyard Composers Grave':                                ("C作曲家の墓Cには", None, 'region'),
    'Graveyard Dampes Grave':                                   ("Cダンペイの墓Cには", None, 'region'),
    'DMT Cow Grotto':                                           ("孤独なC牛Cには", None, 'region'),
    'HC Storms Grotto':                                         ("砂っぽいC脆壁の穴Cには", None, 'region'),
    'HF Tektite Grotto':                                        ("CテクタイトCのいる穴には", None, 'region'),
    'HF Near Kak Grotto':                                       ("C２色のクモCのいる穴には", None, 'region'),
    'HF Cow Grotto':                                            ("Cクモの巣Cだらけの穴には", None, 'region'),
    'Kak Redead Grotto':                                        ("CリーデッドCのいる穴には", None, 'region'),
    'SFM Wolfos Grotto':                                        ("CウルフォスCのいる穴には", None, 'region'),
    'GV Octorok Grotto':                                        ("CオクタンCのいる穴には", None, 'region'),
    'Deku Theater':                                             ("C仮面博覧会Cには", None, 'region'),
    'ZR Open Grotto':                                           ("C穴Cには", None, 'region'),
    'DMC Upper Grotto':                                         ("C穴Cには", None, 'region'),
    'DMT Storms Grotto':                                        ("C穴Cには", None, 'region'),
    'Kak Open Grotto':                                          ("C穴Cには", None, 'region'),
    'HF Near Market Grotto':                                    ("C穴Cには", None, 'region'),
    'HF Open Grotto':                                           ("C穴Cには", None, 'region'),
    'HF Southeast Grotto':                                      ("C穴Cには", None, 'region'),
    'KF Storms Grotto':                                         ("C穴Cには", None, 'region'),
    'LW Near Shortcuts Grotto':                                 ("C穴Cには", None, 'region'),
    'HF Inside Fence Grotto':                                   ("Cアキンド穴Cには", None, 'region'),
    'LW Scrubs Grotto':                                         ("Cアキンド穴Cには", None, 'region'),
    'Colossus Grotto':                                          ("C２体のアキンド穴Cには", None, 'region'),
    'ZR Storms Grotto':                                         ("C２体のアキンド穴Cには", None, 'region'),
    'SFM Storms Grotto':                                        ("C２体のアキンド穴Cには", None, 'region'),
    'GV Storms Grotto':                                         ("C２体のアキンド穴Cには", None, 'region'),
    'LH Grotto':                                                ("C３体のアキンド穴Cには", None, 'region'),
    'DMC Hammer Grotto':                                        ("C３体のアキンド穴Cには", None, 'region'),
    'GC Grotto':                                                ("C３体のアキンド穴Cには", None, 'region'),
    'LLR Grotto':                                               ("C３体のアキンド穴Cには", None, 'region'),
    'ZR Fairy Grotto':                                          ("C妖精の泉Cには", None, 'region'),
    'HF Fairy Grotto':                                          ("C妖精の泉Cには", None, 'region'),
    'SFM Fairy Grotto':                                         ("C妖精の泉Cには", None, 'region'),
    'ZD Storms Grotto':                                         ("C妖精の泉Cには", None, 'region'),
    'GF Storms Grotto':                                         ("C妖精の泉Cには", None, 'region'),
    ...
    '1048':                                                     ("<ムニッムニッムニッ&ムニッムニッムニッ&ムニッムニッムニッ^<ムニッムニッムニッ&ムニッムニッムニッ&ムニッムニッムニッ^<ムニッムニッムニッ&ムニッムニッムニッ&ムニッ", None, 'junk'),
    ...
    'Deku Tree':                                                ("C古代の樹Cには", "Cデクの樹Cには", 'dungeonName'),
    'Dodongos Cavern':                                          ("C巨大な洞窟Cには", "Cドドンゴの洞窟Cには", 'dungeonName'),
    'Jabu Jabus Belly':                                         ("C神の腹の中Cには", "Cジャブジャブ様のお腹Cには", 'dungeonName'),
    'Forest Temple':                                            ("C深き森Cには", "C森の神殿Cには", 'dungeonName'),
    'Fire Temple':                                              ("C高き山Cには", "C炎の神殿Cには", 'dungeonName'),
    'Water Temple':                                             ("C広き湖Cには", "C水の神殿Cには", 'dungeonName'),
    'Shadow Temple':                                            ("C屍の館Cには", "C闇の神殿Cには", 'dungeonName'),
    'Spirit Temple':                                            ("C砂の女神Cには", "C魂の神殿Cには", 'dungeonName'),
    'Ice Cavern':                                               ("C凍った迷路Cには", "C氷の洞窟Cには", 'dungeonName'),
    'Bottom of the Well':                                       ("C三拍子の井戸Cには", "C井戸の底Cには", 'dungeonName'),
    'Gerudo Training Ground':                                   ("C盗人のテストCでは", "Cゲルド修練場Cには", 'dungeonName'),
    'Ganons Castle':                                            ("C乗っ取られた城Cには", "Cガノン城Cには", 'dungeonName'),
    ...
    'bridge_vanilla':                                           ("C闇と魂のメダルCそしてC光の矢C", None, 'bridge'),
    ...
    'ganonBK_keysanity':                                        ("CどこかCに隠されている", None, 'ganonBossKey'),
    ...
    'lacs_vanilla':                                             ("闇と魂のメダル", None, 'lacs'),
    ...
    'Child Altar Text End':                                     ("<~\x07勇者なるもの、&時のオカリナをもち、&時の歌を　奏でよ。", None, 'altar'),
