...
location_table = OrderedDict([
    ...
    ("Ice Cavern Spinning Scythe Silver Rupee Icicles",              ("Silver Rupee", 0x09,  None, None,    'Silver Rupee (Ice Cavern Spinning Scythe)',                 ("Ice Cavern", "Vanilla", "Silver Rupee"))),
    ("Ice Cavern Spinning Scythe Silver Rupee Center Left",          ("Silver Rupee", 0x09,  None, None,    'Silver Rupee (Ice Cavern Spinning Scythe)',                 ("Ice Cavern", "Vanilla", "Silver Rupee"))),
    ("Ice Cavern Spinning Scythe Silver Rupee Center Back",          ("Silver Rupee", 0x09,  None, None,    'Silver Rupee (Ice Cavern Spinning Scythe)',                 ("Ice Cavern", "Vanilla", "Silver Rupee"))),
    ("Ice Cavern Spinning Scythe Silver Rupee Center Right",         ("Silver Rupee", 0x09,  None, None,    'Silver Rupee (Ice Cavern Spinning Scythe)',                 ("Ice Cavern", "Vanilla", "Silver Rupee"))),
    ("Ice Cavern Spinning Scythe Silver Rupee Ledge",                ("Silver Rupee", 0x09,  None, None,    'Silver Rupee (Ice Cavern Spinning Scythe)',                 ("Ice Cavern", "Vanilla", "Silver Rupee"))),
